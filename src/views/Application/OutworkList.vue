...
export default {
  ...
  methods: {
    getlist() {
      ...
      this.axios(
        "https://localhost:44360/api/Application/GetOutworkApplication?applicant=" +
          userid
      ).then((res) => {
    ...
    getinfo(id) {
      this.axios(
        "https://localhost:44360/api/Application/GetOutworkModel?id=" + id
      ).then((res) => {
    ...
    save() {
      ...
      this.axios
        .post("https://localhost:44360/api/Application/OutWorkSave", this.form)
        .then((res) => {
          if (res.data) {
            this.dialogFormVisible = false;
    ...
    del(id) {
      this.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
        ...
        .then(() => {
          this.axios
            .delete(
              "https://localhost:44360/api/Application/DelOutwork?id=" + id
            )
            .then((res) => {
              if (res.data) {
                this.getlist();
